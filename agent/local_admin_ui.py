...
const CONTENT_TEXT = [
  ...
  ['kiosk_time_label', 'ป้ายเวลาเข้า-ออก'], ['kiosk_status_label', 'ป้ายสถานะ'],
  ['kiosk_success_label', 'ข้อความสถานะสำเร็จ'],
...
const FLAGS = [
  ...
  ['cctv_always_on', 'กล้องทำงานตลอดเวลาเหมือนกล้องวงจรปิด (พักแค่หน้าจอ ไม่ปิดเครื่อง)'],
...
async function renderDevices(view) {
  ...
  view.innerHTML = `<div class="card"><h3>เปิดให้ตู้สแกนอื่นเชื่อมต่อ</h3>
      ...
      ไม่ต้องเริ่มโปรแกรมใหม่ ใช้ได้ทันที<br />
