...
<style>
  ...
  * { box-sizing:border-box; }
  ...
  @media(orientation:portrait) and (min-width:600px){
    ...
    .waiting{display:grid;grid-template-columns:minmax(0,.9fr) minmax(0,1.1fr);grid-template-rows:auto minmax(0,1fr);gap:12px 18px;margin-top:14px}
    .ready{grid-column:1;grid-row:1}.visitorBox{grid-column:1;grid-row:2;margin:0;min-height:0;justify-content:center}.visitorBox img{width:118px;height:118px}
    .listTitle{grid-column:2;grid-row:1;margin:0;align-self:end}.list{grid-column:2;grid-row:2;min-height:0}
...
<div class="app">
  ...
  <aside class="side"><div class="welcome"><i>✦</i><span id="welcome">ยินดีต้อนรับเข้าสู่โรงเรียนของเรา</span></div>
    ...
    <div class="waiting" id="waiting"><div class="ready"><small>FACEGATE READY</small><h2 id="subtitle">กรุณายืนให้ใบหน้าตรงกับกรอบใบหน้าบนหน้าจอ</h2><p id="readyDetail">ระบบพร้อมสำหรับการสแกน</p></div><div class="listTitle"><span>สแกนเข้าล่าสุด</span><small>วันนี้</small></div><div class="list" id="list"></div></div>
  </aside>
</div>
