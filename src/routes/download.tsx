          ...
          <Tabs defaultValue="windows">
            ...
            <TabsContent value="windows" className="space-y-5 pt-6">
              ...
              <div className="rounded-2xl border-2 border-emerald-300/60 bg-emerald-50/60 p-5">
                ...
                <p className="mt-4 rounded-xl bg-white/70 p-3 text-sm leading-relaxed text-slate-600">
                  <span className="font-semibold text-emerald-700">ใช้หลายตู้สแกนในโรงเรียนเดียว:</span>{" "}
                  ติดตั้งไฟล์เดียวกันทุกเครื่อง เลือกเครื่องหนึ่งเป็น “เครื่องแม่” แล้วเปิดโหมดวง LAN ที่
                  หลังบ้าน → ตู้สแกนในวง LAN → เพิ่มตู้สแกนเพื่อรับที่อยู่เครื่องแม่และรหัสเชื่อมต่อ
                  จากนั้นที่เครื่องลูกเลือกโหมด “ตู้สแกนลูก” และกรอกที่อยู่กับรหัสนั้น
                  ประวัติทุกตู้จะรวมอยู่ที่เครื่องแม่ และกันสแกนซ้ำข้ามตู้ให้อัตโนมัติ
                </p>
              </div>
