...
function DoorPage() {
  ...
  const wiring: Array<[string, string, string]> = [
    ["P0", "ขา IN ของรีเลย์ 5V", "สัญญาณสั่งปลดล็อกกลอนไฟฟ้า"],
    ["P1", "ขาสัญญาณ Buzzer", "เสียงยืนยันผ่าน / เสียงเตือนเมื่อถูกปฏิเสธ"],
    ["P2", "ขาสัญญาณ Servo (ทางเลือก)", "ใช้แทนรีเลย์ ถ้าเป็นกลอนแบบก้านหมุน"],
    ["3V", "VCC ของรีเลย์", "ไฟเลี้ยงเฉพาะวงจรควบคุม"],
    ["GND", "GND ของรีเลย์และแหล่งจ่ายกลอน", "ต่อกราวด์ร่วมกันเสมอ"],
  ];
