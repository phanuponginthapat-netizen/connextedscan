      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <pre className="overflow-x-auto rounded-lg border bg-muted/40 p-4 text-xs leading-relaxed">{`  [กล้อง] → [เครื่องตู้สแกน + FaceGate] --USB--> [micro:bit]
                                                    |P2
                                                 [Servo] --- ยกขึ้น 90° ---> [ไม้กั้น]`}</pre>
          <div className="space-y-2 rounded-lg border bg-muted/30 p-3 text-xs leading-relaxed">
            <p className="font-medium">ไม้กั้นกระดาษลัง — เซอร์โวตัวเล็กในกล่องยกไหวไหม?</p>
            <p className="text-muted-foreground">
              ยกไหวครับ ถ้าไม้กั้นเป็นกระดาษลังยาวไม่เกิน 30–40 ซม. และน้ำหนักรวมไม่เกินราว 30 กรัม
              เซอร์โว SG90 (ตัวเล็กสีฟ้าที่มากับกล่องชุด micro:bit) มีแรงบิดราว 1.5 กก.-ซม.
              ซึ่งพอสำหรับงานสาธิต
            </p>
            <p className="text-muted-foreground">
              เคล็ดลับให้ยกได้นิ่ง: ให้แกนหมุนอยู่ใกล้ปลายด้านท้ายของไม้กั้น
              ถ่วงน้ำหนักเล็กน้อยที่ท้ายไม้ให้เกือบสมดุล เจาะรูกลางลังให้เบาลง
              และยึดตัวเซอร์โวกับฐานที่หนักพอไม่ให้กระดก ถ้าไม้ยาวเกิน 50 ซม.
              หรือใช้ไม้จริง ให้เปลี่ยนเป็น MG996R พร้อมไฟเลี้ยง 5V แยก
            </p>
          </div>
          <p className="rounded-lg border border-amber-500/40 bg-amber-500/10 p-3 text-xs">
            ความปลอดภัย: อย่าจ่ายไฟมอเตอร์ตัวใหญ่ผ่าน micro:bit โดยตรง ให้ใช้แหล่งจ่าย 5V แยกและต่อกราวด์ร่วม
            และควรมีทางออกฉุกเฉินเสมอ (กดปุ่ม A บน micro:bit ยกไม้กั้นเอง, ปุ่ม B สั่งลง)
          </p>
        </CardContent>
      </Card>
